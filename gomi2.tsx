...
export default function Observation() {
    ...
    const checkWinner = (turn: string, player1: number[], player2: number[]) => {
        let checkWinner = '';
        ...
        // 先攻の判定
        // 横方向判定
        // checkFirstPlayerの配列の中に1～8以下の数字が5個以上ある

        // checkFirstPlayerの配列の中に9～16以下の数字が5個以上ある

        // checkFirstPlayerの配列の中に17～24以下の数字が5個以上ある

        // checkFirstPlayerの配列の中に25～32以下の数字が5個以上ある

        // checkFirstPlayerの配列の中に33～40以下の数字が5個以上ある

        // checkFirstPlayerの配列の中に41〜48以下の数字が5個以上ある

        // checkFirstPlayerの配列の中に49～56以下の数字が5個以上ある

        // checkFirstPlayerの配列の中に57～64以下の数字が5個以上ある

        // 縦方向判定
        // checkFirstPlayerの配列の中に1、9、17、25、33、41、49、57の数字が5個以上ある

        // checkFirstPlayerの配列の中に2、10、18、26、34、42、50、58の数字が5個以上ある

        // checkFirstPlayerの配列の中に3、11、19、27、35、43、51、59の数字が5個以上ある

        // checkFirstPlayerの配列の中に4、12、20、28、36、44、52、60の数字が5個以上ある

        // checkFirstPlayerの配列の中に5、13、21、29、37、45、53、61の数字が5個以上ある

        // checkFirstPlayerの配列の中に6、14、22、30、38、46、54、62の数字が5個以上ある

        // checkFirstPlayerの配列の中に7、15、23、31、39、47、55、63の数字が5個以上ある

        // checkFirstPlayerの配列の中に8、16、24、32、40、48、56、64の数字が5個以上ある

        // 斜め方向判定
        // checkFirstPlayerの配列の中に4、13、22、31、40の数字がすべてある → 勝利

        // checkFirstPlayerの配列の中に3、12、21、30、39、48の数字が5個以上ある

        // checkFirstPlayerの配列の中に2、11、20、29、38、47、56の数字が5個以上ある

        // checkFirstPlayerの配列の中に1、10、19、28、37、46、55、64の数字が5個以上ある

        // checkFirstPlayerの配列の中に9、18、27、36、45、54、63の数字が5個以上ある

        // checkFirstPlayerの配列の中に17、26、35、44、53、62の数字が5個以上ある

        // checkFirstPlayerの配列の中に25、34、43、52、61の数字がすべてある → 勝利

        // checkFirstPlayerの配列の中に5、12、19、26、33の数字がすべてある → 勝利

        // checkFirstPlayerの配列の中に6、13、20、27、34、41の数字が5個以上ある

        // checkFirstPlayerの配列の中に7、14、21、28、35、42、49の数字が5個以上ある

        // checkFirstPlayerの配列の中に8、15、22、29、36、43、50、57の数字が5個以上ある

        // checkFirstPlayerの配列の中に16、23、30、37、44、51、58の数字が5個以上ある

        // checkFirstPlayerの配列の中に24、31、38、45、52、59の数字が5個以上ある
